...
import GSTandOtherInformationFields from "./components/GSTandOther";
      ...
      <Suspense fallback={<Loading loading={true} />}>
        <Formik
          ...
          onSubmit={(values, { setSubmitting }) => {
            ...
            // Log GST data being sent to backend
            console.log('🚀 Foreign Invoice Data Being Sent to Backend:', formData);
            console.log('📊 GST & Other Details:', formData.DispatchShippingAndOtherDetails);
            console.log('📋 Bill Type:', formData.DispatchShippingAndOtherDetails.bill_type);
            console.log('💰 IGST:', formData.DispatchShippingAndOtherDetails.i_gst);
            console.log('💰 CGST:', formData.DispatchShippingAndOtherDetails.c_gst);
            console.log('💰 SGST:', formData.DispatchShippingAndOtherDetails.s_gst);
            console.log('📄 E-Way Bill:', formData.DispatchShippingAndOtherDetails.e_way_bill_no);
            console.log('📝 Remark:', formData.DispatchShippingAndOtherDetails.remark);
              ...
              <Form key="invoiceForm">
                <FormContainer key="invoiceFormContainer">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <Card className="bg-yellow-50 h-max">
                      <h5 className="font-semibold text-gray-700">
